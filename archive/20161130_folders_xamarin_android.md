...
It can be mounted on a computer and any files is publicly available. Also any app with EXTERNAL_STORAGE read/write access will be able to access and modify these files.
