...
I already went through [how to get started with `Deedle` in a previous tutorial (Part 1)](https://kimsereyblog.blogspot.co.uk/2016/04/a-primer-on-manipulating-data-frame.html) which you can refer to if you never heard of `Deedle`.
